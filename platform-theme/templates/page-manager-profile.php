...
<div class="mpp-card">
	<?php if ( $can_edit ) : ?>
		<form method="post" class="mpp-form">
			...
			<input type="hidden" name="mpp_redirect" value="<?php echo esc_url( function_exists( 'mpp_route_url' ) ? mpp_route_url( 'app/manager/profile' ) : home_url( '/app/manager/profile' ) ); ?>">
